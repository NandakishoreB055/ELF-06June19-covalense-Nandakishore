...
<%@page import="com.covalense.empmngmnt.EmployeeData"%>
<html>
<head>
<meta charset='UTF-8'>
...
<link rel="stylesheet"
	...
	integrity="sha384-ggOyR0iXCbMQv3Xipma34MDdH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T"
...
<body>
	...
	<%
		EmployeeData bean = (EmployeeData) request.getAttribute("bean");
	%>
