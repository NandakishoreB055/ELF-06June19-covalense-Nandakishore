...
public class ManyToOneTest3 {
	public static void main(String[] args) {
		...
		EmployeeExpPriKeyBean expPKBean1 = new EmployeeExpPriKeyBean();
		expPKBean1.setCompanyNM("cov");
		expPKBean1.setInfoBean(bean);

		EmployeeExpPriKeyBean expPKBean2 = new EmployeeExpPriKeyBean();
		expPKBean2.setCompanyNM("covl");
		expPKBean2.setInfoBean(bean);

		EmployeeExpInfoBean expInfo1 = new EmployeeExpInfoBean();
		expInfo1.setEmpExp(expPKBean1);
		expInfo1.setDesignation("sd");
		expInfo1.setJoiningDate(date);

		EmployeeExpInfoBean expInfo2 = new EmployeeExpInfoBean();
		expInfo1.setEmpExp(expPKBean2);
		expInfo1.setDesignation("sd");
		expInfo1.setJoiningDate(date);
		...
		impl.createEmployee(bean, otherInfoBean, Arrays.asList(addressInfo1, addressInfo2),
				...
				Arrays.asList(expInfo1, expInfo1));
